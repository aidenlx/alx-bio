...
export { join, basename, dirname, resolve } from "https://deno.land/std@0.193.0/path/mod.ts";
...
export { parse as yamlParse, stringify as yamlStringify } from "https://deno.land/std@0.193.0/yaml/mod.ts";
